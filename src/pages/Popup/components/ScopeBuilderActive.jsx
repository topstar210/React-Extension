            ...
            <div className=" flex-1 flex flex-col px-[32px] ">
                ...
                <div className="h-full w-full bg-gradient-green rounded-[10px] flex items-center justify-center">
                    <div>
                        ...
                        <div className="my-[32px]">
                            <span className='text-[20px] font-medium block text-center  '>ScopeBuilder Connected</span>
                            <span className=' text-[12px] block text-center '>
                            Congratulations! You’ve successfully linked your ScopeBuilder account.
                            </span>
                        </div>
                        <div className='w-fit mx-auto'>
                            <Link to={'/Home'} className=" bg-white font-medium uppercase text-[#66DC78] text-[16px] py-[16px] px-[32px] rounded-[4px] ">
