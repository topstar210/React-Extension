...
const ScopeBuilder = ({ fill = '#1890ff' }) => {
    ...
    return (
        <div className='flex flex-col h-full' >
            <Header link='Login' text={'log out'} showButton={true} styles={'bg-[#000000]'} />
            <div className="flex-1 flex flex-col px-[32px] ">
                <div className="flex items-center gap-[16px] ">
                    <button onClick={() => navigate(-1)} className=" rotate-180 w-[57px] h-[57px] bg-[#282828]  flex justify-center items-center rounded-full relative ">
                        {/* arrow */}
                        <svg
                    ...
                    <div className="my-[32px]">
                        <div className="flex flex-col gap-[8px]">
                            <span className="uppercase font-medium text-[20px] ">ScopeBuilder</span>
                ...
                <div className="bg-gradient-blue flex-1 rounded-[10px] flex items-center justify-center">
                    <div>
                        ...
                        <div className="my-[32px]">
                            <span className='text-[20px] font-medium block text-center  '>Connect ScopeBuilder</span>
                            <span className='text-[12px] block text-center'>
                                Connect with your ScopeBuilder account and use for free!
                            </span>
                        </div>
                        <div className='w-fit mx-auto'>
                            <Link to={'/StatusConnecting'} className=" bg-white font-medium uppercase text-[#1890FF] text-[16px] py-[16px] px-[32px] rounded-[4px] ">
                                Connect Now
                            </Link>
                        </div>
                    </div>
