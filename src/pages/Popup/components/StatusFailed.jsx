        ...
        <div className="h-full w-full  bg-gradient-red rounded-[10px] flex items-center justify-center">
            <div>
                ...
                <div className="my-[32px]">
                    <span className='text-[20px] font-medium block text-center'>Connection Failed</span>
                ...
                <div className='w-fit mx-auto'>
                    <Link to={'/KeywordsConnected'} className=" mr-[10px] bg-white font-medium uppercase text-[#FF1818] text-[16px] py-[16px] px-[32px] rounded-[4px] ">
                        cancel
                    </Link>
                    <Link to={'/KeywordsConnected'} className=" bg-[#920000] font-medium uppercase text-white text-[16px] py-[16px] px-[32px] rounded-[4px] ">
                        Retry Connection
                    </Link>
